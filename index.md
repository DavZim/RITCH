...
- `read_itch(file, ...)` to read an ITCH file Convenient wrappers for
  ...
  provided as
  [`read_orders()`](https://davzim.github.io/RITCH/reference/read_functions.md),
  [`read_trades()`](https://davzim.github.io/RITCH/reference/read_functions.md),
  …
...
- `download_sample_file(choice)` to download a sample file from the
  NASDAQ server and
  [`list_sample_files()`](https://davzim.github.io/RITCH/reference/list_sample_files.md)
  to get a list of all available sample files
- `download_stock_directory(exchange, date)` to download the stock
  locate information for a given exchange and date
- [`open_itch_sample_server()`](https://davzim.github.io/RITCH/reference/open_itch_sample_server.md)
  to open the official NASDAQ server in your browser, which hosts among
  other things example data files
...
- [`open_itch_specification()`](https://davzim.github.io/RITCH/reference/open_itch_specification.md)
  to open the official NASDAQ ITCH specification PDF in your browser
...
[`write_itch()`](https://davzim.github.io/RITCH/reference/write_itch.md)
function allows you to write a single or multiple types of message to an
`ITCH_50` file. Note however, that only the standard columns are
supported. Additional columns will not be written to file!
...
| Type | `RITCH` Class             | `RITCH` Read Function                                                                            | ITCH Name                                 | ITCH Spec Section |
|:-----|:--------------------------|:-------------------------------------------------------------------------------------------------|:------------------------------------------|:------------------|
| `S`  | system_events             | [`read_system_events()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | System Event Message                      | 4.1               |
| `R`  | stock_directory           | [`read_stock_directory()`](https://davzim.github.io/RITCH/reference/read_functions.md)           | Stock Directory                           | 4.2.1             |
| `H`  | trading_status            | [`read_trading_status()`](https://davzim.github.io/RITCH/reference/read_functions.md)            | Stock Trading Action                      | 4.2.2             |
| `Y`  | reg_sho                   | [`read_reg_sho()`](https://davzim.github.io/RITCH/reference/read_functions.md)                   | Reg SHO Restriction                       | 4.2.3             |
| `L`  | market_participant_states | [`read_market_participant_states()`](https://davzim.github.io/RITCH/reference/read_functions.md) | Market Participant Position               | 4.2.4             |
| `V`  | mwcb                      | [`read_mwcb()`](https://davzim.github.io/RITCH/reference/read_functions.md)                      | MWCB Decline Level Message                | 4.2.5.1           |
| `W`  | mwcb                      | [`read_mwcb()`](https://davzim.github.io/RITCH/reference/read_functions.md)                      | MWCB Status Message                       | 4.2.5.2           |
| `K`  | ipo                       | [`read_ipo()`](https://davzim.github.io/RITCH/reference/read_functions.md)                       | IPO Quoting Period Update                 | 4.2.6             |
| `J`  | luld                      | [`read_luld()`](https://davzim.github.io/RITCH/reference/read_functions.md)                      | LULD Auction Collar                       | 4.2.7             |
| `h`  | trading_status            | [`read_trading_status()`](https://davzim.github.io/RITCH/reference/read_functions.md)            | Operational Halt                          | 4.2.8             |
| `A`  | orders                    | [`read_orders()`](https://davzim.github.io/RITCH/reference/read_functions.md)                    | Add Order Message                         | 4.3.1             |
| `F`  | orders                    | [`read_orders()`](https://davzim.github.io/RITCH/reference/read_functions.md)                    | Add Order - MPID Attribution Message      | 4.3.2             |
| `E`  | modifications             | [`read_modifications()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | Order Executed Message                    | 4.4.1             |
| `C`  | modifications             | [`read_modifications()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | Order Executed Message With Price Message | 4.4.2             |
| `X`  | modifications             | [`read_modifications()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | Order Cancel Message                      | 4.4.3             |
| `D`  | modifications             | [`read_modifications()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | Order Delete Message                      | 4.4.4             |
| `U`  | modifications             | [`read_modifications()`](https://davzim.github.io/RITCH/reference/read_functions.md)             | Order Replace Message                     | 4.4.5             |
| `P`  | trades                    | [`read_trades()`](https://davzim.github.io/RITCH/reference/read_functions.md)                    | Trade Message (Non-Cross)                 | 4.5.1             |
| `Q`  | trades                    | [`read_trades()`](https://davzim.github.io/RITCH/reference/read_functions.md)                    | Cross Trade Message                       | 4.5.2             |
| `B`  | trades                    | [`read_trades()`](https://davzim.github.io/RITCH/reference/read_functions.md)                    | Broken Trade Message                      | 4.5.3             |
| `I`  | noii                      | [`read_noii()`](https://davzim.github.io/RITCH/reference/read_functions.md)                      | NOII Message                              | 4.6               |
| `N`  | rpii                      | [`read_rpii()`](https://davzim.github.io/RITCH/reference/read_functions.md)                      | Retail Interest Message                   | 4.7               |
...
which can also be opened by calling
[`open_itch_specification()`](https://davzim.github.io/RITCH/reference/open_itch_specification.md).
...
check
[`?ex20101224.TEST_ITCH_50`](https://davzim.github.io/RITCH/reference/ex20101224.TEST_ITCH_50.md).
...
[`open_itch_sample_server()`](https://davzim.github.io/RITCH/reference/open_itch_sample_server.md))
which can be used to test code on larger datasets. Note that the sample
files are up to 5GB compressed, which inflate to about 13GB. To interact
with the sample files, use
[`list_sample_files()`](https://davzim.github.io/RITCH/reference/list_sample_files.md)
and `download_sample_files()`.
...
supplied (either by providing the output from
...
![](reference/figures/README-ETF_plot-1.png)
