...
get_meta_data <- function() {
  meta <- data.table(
    ...
    msg_group = c("System Event Message", "Stock Related Messages", 
                  "Stock Related Messages", "Stock Related Messages",
                  "Stock Related Messages", "Stock Related Messages", 
                  "Stock Related Messages", "Stock Related Messages", 
                  "Stock Related Messages", "Add Order Message", 
                  "Add Order Message", "Modify Order Messages",
                  "Modify Order Messages", "Modify Order Messages", 
                  "Modify Order Messages", "Modify Order Messages",
                  "Trade Messages", "Trade Messages", "Trade Messages", 
