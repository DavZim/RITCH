...
An R Library to parse financial data using Rcpp (fast and efficient), see comprehensive README.md.
...
Also, additional dependencies need to be explicitly allowed before they are added!
